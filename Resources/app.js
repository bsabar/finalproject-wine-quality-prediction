const wine_data = "https://2u-data-curriculum-team.s3.amazonaws.com/dataviz-classroom/v1.1/14-Interactive-Web-Visualizations/02-Homework/samples.json";

function initMenu() {
    let dropDownMenu = d3.select("#selDataset");
    d3.json(wine_data).then((data) => {
        console.log(data);
        let wine_data = data.names;
        wine_data.forEach((wine_data) => {
